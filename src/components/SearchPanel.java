...
public class SearchPanel extends PanelRoundRect implements ActionListener{
	...
	public SearchPanel() {
		...
		combo_button.setIcon(ImageRGBA.alterImageIcon(Resource.get("filter.png"), combo_button.getForeground(), combo_button));
		...
		search_button.setIcon(ImageRGBA.alterImageIcon(Resource.get("search.png"), main_color[2], search_button));
