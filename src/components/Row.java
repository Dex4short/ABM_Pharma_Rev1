...
public class Row extends PanelRoundRect implements MouseListener, ItemListener{
	...
	public Row(Cell cell[]) {
		...
		normal    = new Decoration(font[0], main_color[2], main_color[2]);
		hover     = new Decoration(font[0], main_color[3], main_color[2]);
		highlight = new Decoration(font[0], new Color(0,0,0,0), main_color[3]);
