...
public class TabPane extends JPanel implements Theme{
	...
	private class TabHead extends JPanel implements ComponentListener{
		...
		public TabHead() {
			...
			tab_head.setOpaque(false);
			tab_head.addComponentListener(this);
		}
		@Override
	...
	private class TabBody extends PanelRoundRect{
		private static final long serialVersionUID = 1L;

		public TabBody() {
			tab_body.setArc(10);
			tab_body.setCorner(0, false);
			tab_body.setLayout(new BorderLayout());
			tab_body.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
		}
	}
